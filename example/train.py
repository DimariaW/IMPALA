...
import parl
import paddle
from example.atari_model import AtariModel
from example.atari_agent import AtariAgent
...
from example.actor import Actor
...
class Learner(object):
    ...
    def _reader(self):
        while True:
            ...
            if buffer_size >= self.config['train_batch_size']:
                ...
                dones_np = batch['dones'].astype('bool')
    ...
    def run_learn(self):
        ...
        loader.set_batch_generator(self._batch_reader())

        for obs_np, actions_np, behaviour_logits_np, rewards_np, dones_np in loader(
        ):
...
if __name__ == '__main__':
    from example.impala_config import config
